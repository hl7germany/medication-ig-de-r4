...
* extension[renderedDosageInstruction]
  ...
  * ^definition = "Diese R5 backport Extension enthält die gerenderten Dosierungsanweisungen, die für den Patienten bestimmt sind, um eine klare und verständliche Anweisung zur Einnahme des Medikaments zu geben."
  * valueMarkdown
