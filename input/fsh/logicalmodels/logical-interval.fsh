...
* insert Dosis
* insert Wiederholung
* dosierungsdetails.wiederholung.haeufigkeit 1..1 BackboneElement "Häufigkeit der Anwendung: wie oft je Zeitraum eine Dosis angewendet wird (z.B. „dreimal täglich“)."
