...
* dosierungsdetails.wiederholung.uhrzeiten 0..* time "Uhrzeit(en) der Anwendung an den ausgewählten Wochentagen. Alternativ zur Tageszeit anzugeben."
* dosierungsdetails.wiederholung.tageszeiten 0..* Coding "Tageszeit(en) an den ausgewählten Wochentagen, ausgedrückt als morgens | mittags | abends | zur Nacht. Alternativ zur Uhrzeit anzugeben."
