...
Description: "Beispiel, das ein eingebettetes Viererschema (1-1-1-1) in Dosage.text enthält, um die Warn-Invariante auszulösen."
...
* status = #active
* medicationCodeableConcept.text = "Amoxicillin 500mg"
* dosage[0].text = "Einnahme nach Schema 1-1-1-1"
