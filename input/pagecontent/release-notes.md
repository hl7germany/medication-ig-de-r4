...
Eintrag fasst alle Änderungen seit 1.0.5 zusammen; die dazwischenliegenden
Versionen 1.0.6 und 1.0.7 waren technisch getrieben und ohne fachliche Änderung.
...
- **Fehlerkorrektur in der `package.json`**
  ...
  - Keine fachlichen Änderungen; das Release stellt lediglich sicher, dass die Abhängigkeiten unverändert zu Version 1.0.4 bleiben.
