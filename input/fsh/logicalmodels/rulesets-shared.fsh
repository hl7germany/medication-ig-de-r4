...
* dosierungsdetails.dosis.einheit from $kbv-dosiereinheit-vs (required)

RuleSet: Zeitangaben
* dosierungsdetails.zeitangaben 0..1 Base "Angaben dazu, wann die Dosierung angewendet wird."
...
* dosierungsdetails.zeitangaben.zeitrahmen.dauer.einheit from DurationUnitsOfTimeDgMPVS (required)
